...
cluster = MongoClient("mongodb+srv://loker:loker@cluster0.palm0.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
db = cluster["sgtest"]
users = db["users"]
orders = db["orders"]
...
def reply():
    ...
    if bool(user) == False:
        msg = res.message("Hi, thanks for contacting *SmartGadget.Info*.\nYou can choose from one of the options below: "
                    "\n\n*Type*\n\n 1️⃣ To *contact* us \n 2️⃣ To *order* snacks \n 3️⃣ To know our *working hours* \n 4️⃣ "
                    "To get our *address*")
        msg.media("https://smartgadget.info/image/data/logo_143x59.png")
